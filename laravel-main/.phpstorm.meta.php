...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.kader.driver' => 'string',
            'auth.guards.kader.provider' => 'string',
            'auth.guards.warga.driver' => 'string',
            'auth.guards.warga.provider' => 'string',
            'auth.providers.users.driver' => 'string',
            'auth.providers.users.model' => 'string',
            'auth.providers.kaders.driver' => 'string',
            'auth.providers.kaders.model' => 'string',
            'auth.providers.wargas.driver' => 'string',
            'auth.providers.wargas.model' => 'string',
            ...
            'filesystems.links.C:\xampp\htdocs\DengueCare1\public\storage' => 'string',
...
'auth.guards.kader.driver','auth.guards.kader.provider','auth.guards.warga.driver','auth.guards.warga.provider','auth.providers.users.driver',
'auth.providers.users.model','auth.providers.kaders.driver','auth.providers.kaders.model','auth.providers.wargas.driver','auth.providers.wargas.model',
...
'filesystems.links.C:\\xampp\\htdocs\\DengueCare1\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'web','api',);
        registerArgumentsSet('routes', 'welcome','kader.login','kader.login.submit','kader.logout',
'kader.dashboard','pelatihan.saya','daftar-pelatihan','daftar.pelatihan','batalkan-pelatihan',
'laporan.harian','tracking-harian.store','tracking-harian.show','laporan.index','laporan.download-template',
'laporan.upload','data-warga','warga-detail','kader.forum','forum.post.store',
'forum.comment.store','kader.buku-panduan','buku-panduan.search','buku-panduan.cover','buku-panduan.download',
'buku-panduan.stream','buku-panduan.info','buku-panduan.debug','kader.video-pelatihan','kader.video_detail',
'video-pelatihan.increment-views','video-pelatihan.save','kader.profile','kader.settings','kader.profile.update',
'warga.login','warga.login.submit','warga.logout','register.signup','register.signup.submit',
'register.otp','register.otp.submit','register.otp.resend','register.data_diri','register.datadiri.store',
'register.get.kelurahan','register.get.rw','register.get.rt','register.upload-foto','register.upload-foto.store',
'warga.dashboard','keluhan','keluhan.store','warga.daftar-event',
'warga.register-event','warga.eventsaya','warga.cancel-event','warga.lokasi','lokasi.kelurahan',
'lokasi.rw','lokasi.rt','lokasi.coordinates','warga.riwayat','warga.pelaporan',
'warga.informasi.index','warga.informasi.show','warga.forum.index','warga.forum.store','warga.profile',
'warga.profile.edit','warga.profile.update','warga.riwayat','storage.local',);
        registerArgumentsSet('views', 
'Auth.login_kader','Auth.login_warga','index','kader.buku_panduan','kader.dashboard',
'kader.data_warga','kader.event_kader','kader.forum','kader.laporan_bulanan','kader.profile',
'kader.tracking_harian','kader.video_pelatihan','layouts.auth','layouts.kader','layouts.warga',
'register.data_diri','register.input_foto','register.otp','register.signup','warga.dashboard',
'warga.edit-profile','warga.eventsaya','warga.forum','warga.informasi','warga.lokasi',
'warga.profile','warga.riwayat','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
